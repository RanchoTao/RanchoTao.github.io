...
<section class="home-hero">
  ...
  <p class="home-actions">
    ...
    <a class="btn" href="{{ '/zh/cv/' | relative_url }}">简历</a>
  </p>
</section>
...
<div class="activity-list">
  <article class="activity-item">
    ...
    <p>参与短周期 AI 产品开发与团队协作，并继续推进相关原型。</p>
  </article>
  <article class="activity-item">
    <p class="activity-meta">2026.07 · 参与者</p>
    <h3>北京大学机器学习 Workshop</h3>
    <p>参加机器学习相关学术报告与讨论，拓展对科研实践和研究方向的理解。</p>
  </article>
  <article class="activity-item">
